...
public class UserFriendDao extends BaseDao {
	...
	public List<UserFriend> queryFans(String userId, int offset, int total) {
		...
		map.put("total", total);
		return (List<UserFriend>) this.getSqlMapClientTemplate().queryForList("userFriend.queryFans", map);
	}

	public int queryFansCount(String userId) {

		return (Integer) this.getSqlMapClientTemplate().queryForObject("userFriend.queryFocusCount", userId);
	}
	...
	public List<UserFriend> queryFocus(String userId, int offset, int total) {
		...
		map.put("offset", offset);
		map.put("total", total);
		return (List<UserFriend>) this.getSqlMapClientTemplate().queryForList("userFriend.queryFocus", map);
	}
	...
	public UserFriend queryFocusUser(String userId, String friendId) {
		...
		map.put("userId", userId);
		map.put("friendId", friendId);
		return (UserFriend) this.getSqlMapClientTemplate().queryForObject("userFriend.queryFocusUser", map);
	}

	@SuppressWarnings("unchecked")
	public List<String> queryFocusUserIds(String userId) {

		return (List<String>) this.getSqlMapClientTemplate().queryForList("userFriend.queryFocusUserIds", userId);
	}
