...
<script type="text/javascript" src="../js/admin.talk.js"></script>
</head>
<body>
<form id="searchForm" action="">
	<table>
		...
		<tr>
			<td><a href="javascript:void(0)" id="${item.id}" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="talk.deleteTalk()" >删除</a></td>
