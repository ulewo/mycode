			  		...
			  		<div class="single">
			  			...
			  			<div class="single_center">
				  			...
				  			<c:if test="${article.image!=null&&article.image!=''}">
				  				<div class="single_img"><a href="${realPath}/group/${article.gid}/topic/${article.id}" target="_blank"><img src="${realPath}/images/imgloading.gif" name="${article.image}" style="max-width:150px;"/></a></div>
				  			</c:if>
