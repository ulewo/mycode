...
public class ArticleActivity extends Activity {
	...
	private static final String path = "http://192.168.0.224:8080/ulewo/android/fetchArticle.jspx";
		...
		public void handleMessage(Message msg) {
			...
			try {
				...
				if (requestResult.getResultEnum() == ResultEnum.SUCCESS) {
					...
					adapter = new SimpleAdapter(ArticleActivity.this, list, R.layout.article_item, new String[] {
							"article_title", "article_author", "article_time", "article_recount" }, new int[] {
							R.id.article_title, R.id.article_author, R.id.article_time, R.id.article_recount });
					...
					listView.setOnItemClickListener(new OnItemClickListener() {
						public void onItemClick(AdapterView<?> parent, View view, int postion, long id) {
							...
							Map<String, Object> map = ArticleActivity.this.list.get(postion);
	...
	class MyThread implements Runnable {
		public void run() {
			...
			ArticleActivity.this.myHandler.sendMessage(msg);
