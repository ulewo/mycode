...
,toolbars:[["Source","Undo","Redo","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","FullScreen","Unlink","Link","ClearDoc","|","Date","Time","Map","ImageNone","ImageLeft","ImageRight","ImageCenter","InsertTable","FontFamily","FontSize","ForeColor","BackColor","Bold","Italic","Underline","StrikeThrough","Subscript","Superscript","Spechars","InsertImage","template","background","Emotion","music","InsertVideo","PastePlain","Preview","HighlightCode"]]
//当鼠标放在工具栏上时显示的tooltip提示
,labelMap:{'source':'','undo':'','redo':'','justifyleft':'','justifycenter':'','justifyright':'','justifyjustify':'','fullscreen':'','unlink':'','link':'','cleardoc':'','|':'','attachment':'','date':'','time':'','map':'','imagenone':'','imageleft':'','imageright':'','imagecenter':'','inserttable':'','preview':'','fontfamily':'','fontsize':'','forecolor':'','backcolor':'','bold':'','italic':'','underline':'','strikethrough':'','subscript':'','superscript':'','blockquote':'','spechars':'','insertimage':'','template':'','scrawl':'','background':'','emotion':'','music':'','insertvideo':'','pasteplain':'','highlightcode':''}
