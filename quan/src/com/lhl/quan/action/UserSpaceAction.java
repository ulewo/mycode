...
public class UserSpaceAction extends BaseAction {
	...
	public String userInfo() {
		...
		try {
			...
			blogList = blogArticleService.queryBlogByUserId(userId, 0, 10);
	...
	private String cutImg() {
		...
		try {
			...
			tempPath = ServletActionContext.getServletContext()
					.getRealPath("/")
					+ "/upload/"
					+ yearMonth
					+ "/"
			...
			String okPath = ServletActionContext.getServletContext()
					.getRealPath("/")
					+ "/upload/"
					+ yearMonth
					+ "/"
