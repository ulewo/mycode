...
KE.setting = {
	...
	statusbarHeight : 11,
	items : [
		'fontname', 'fontsize', 'bold','italic', 'underline','textcolor', 'bgcolor','|','justifyleft', 'justifycenter', 'justifyright','|','image',
		'flash', 'media', 'emoticons','|','advtable', 'unlink','link','plainpaste','strikethrough', 'removeformat', '|','code'
	],
	colorTable : [
...
KE.toolbar = {
	updateState : function(id) {
		var cmdList = [
			...
			'justifyfull', 'bold', 'italic', 'underline', 'strikethrough'
		];
...
KE.plugin['fontsize'] = {
	click : function(id) {
		var fontSize = ['12px', '14px', '16px', '18px'];
		var cmd = 'fontsize';
		KE.util.selection(id);
