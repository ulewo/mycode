...
<html>
  <head>
	...
	<style type="text/css">
		#sel_left3 a{background:url(../images/bg.gif) 0px -85px;}
		#sel_left3 a:hover{text-decoration:none;}
	</style>
  </head>
  <body>
  <%@ include file="../common/head.jsp" %>
 	<div class="main">
	  ...
	  <div class="right">
	      <div class="navPath"><a href="userInfo.jspx?userId=${userId}">空间</a>&nbsp;&gt;&gt;&nbsp;加入的窝窝</div>
	  	  <div class="user_main">
