...
(function() {
	...
	window.UEDITOR_CONFIG = {
		...
		,
		toolbars : [ [ "Undo", "Redo", "JustifyLeft", "JustifyCenter",
				"JustifyRight", "JustifyJustify", "FullScreen", "Unlink",
				"Link", "ClearDoc", "|", "Date", "Time", "Map", "ImageNone",
				"ImageLeft", "ImageRight", "ImageCenter", "InsertTable",
				"FontFamily", "FontSize", "ForeColor", "BackColor", "Bold",
				"Italic", "Underline", "StrikeThrough", "Subscript",
				"Superscript", "Spechars", "InsertImage", "Emotion", "music",
				"InsertVideo", "PastePlain", "Preview", "HighlightCode" ] ]
	...
	// , serialize : {
	// //黑名单，编辑器会过滤掉一下标签
	// blackList:{style:1, link:1,object:1, applet:1, input:1, meta:1, base:1,
	// button:1, select:1, textarea:1, '#comment':1, 'map':1, 'area':1}
	// }
