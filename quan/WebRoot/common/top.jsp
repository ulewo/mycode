	...
	<div style="text-align:left;width:1000px;margin:0 auto;padding-top:10px;padding-left:10px;">
		...
		<div class="topConRight">
			<ul>
				...
				<li>/</li>
				<li><a href="../group/allGroups.jspx">圈子</a></li>
				<li>/</li>
...
<div id="login">
	<div class="logincon">
		<div style="text-align:right;margin:10px;height:20px;"><a href="javascript:closeWind()"><img src="../images/tabs_close.gif" border="0"></a></div>
