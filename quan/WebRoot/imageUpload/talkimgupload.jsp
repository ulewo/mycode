...
<body>
<form action="talkImageUpload.jspx" enctype="multipart/form-data" method="post" style="margin:0px;padding:0px;" id="myform">
	<table width="100%" cellpadding="0" cellspacing="0" style="margin:0px;padding:0px;">
		<tr>
			<td><input type="file" name="upload" class="fileUpload" id="upload" onchange="uploadImg()"></td>
			<td><span id="loadingimage" style="display:none;"><img src="../images/loading.gif" width="20" style="float:left;"></span></td>
		</tr>
	</table>
</form>
</body>
