...
<script type="text/javascript">
	$(function(){
		...
		if(imageName!=""){
			parent.getheadIconImage(imageName);
		}
...
<input type="hidden" id="img" value="${uploadFileName}" />
	<form action="headImgUpload.jspx" enctype="multipart/form-data" method="post" style="margin:0px;padding:0px;" id="myform">
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
			<td><input type="file" name="upload" id="upload" style="width:200px;"></td>
			<td><span id="subbutton" class="sbtn"><a href="####"  id="sub" onFocus="this.blur()" >上传</a></span></td>
