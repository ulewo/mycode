...
public class UpYun
{
	...
	public synchronized static UpYun getInstance(String bucketname, String username, String password)
	{

		if (instance == null)
		{
			instance = new UpYun(bucketname, username, password);
		}
		return instance;
	}
	...
	* return true or false
	*/
	public boolean writeFile(String file, InputStream is, Boolean auto) throws Exception
	{
