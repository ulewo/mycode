...
<%
	String searchKey = String.valueOf(request.getAttribute("searchKey"));
	searchKey = URLEncoder.encode(URLEncoder.encode(searchKey, "utf-8"), "utf-8");
	String url = "search?searchKey="+searchKey;
%>
<body>
				...
				<div class="articlePanel">
					  ...
					  <div class="opArea">
					    ...
					    <div class="sharecon">
					      ...
					      <a href="javascript:dispatche(0,'${fn:substring(article.content,0,120)}','${article.imgUrl }',${article.id})" class="qqshare" title="分享到QQ空间"/></a>
					      <a href="javascript:dispatche(1,'${fn:substring(article.content,0,120)}','${article.imgUrl }',${article.id})" class="qqwbshare" title="分享到腾讯微博"/></a>
					      <a href="javascript:dispatche(2,'${fn:substring(article.content,0,120)}','${article.imgUrl }',${article.id})" class="sinawbshare" title="分享到新浪微博"/></a>
					      <a href="javascript:dispatche(3,'${fn:substring(article.content,0,120)}','${article.imgUrl }',${article.id})" class="renrenshare" title="分享到人人网"/></a>
					    </div>
					    <div class="replyCon">
