...
<script type="text/javascript" src="${realPath}/ueditor/ueditor.config.js?version=2.5"></script>
<script type="text/javascript" src="${realPath}/ueditor/ueditor.all.js?version=2.5"></script>
</head>
<body>
