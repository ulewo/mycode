...
<body class="easyui-layout">
	<div data-options="region:'north',border:false">
		<div class="toolbar datagrid-toolbar">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td><a href="javascript:groupManageMember.searchApplyMember()" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">查询</a></td>
					...
					<td><div class="toolbar-line"></div></td>
					<td><a href="javascript:groupManageMember.applyMmeber()" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:true">接受成员</a></td>
					<td><div class="toolbar-line"></div></td>
					<td><a href="javascript:groupManageMember.deleteMember()" class="easyui-linkbutton" data-options="iconCls:'icon-del',plain:true">拒绝成员</a></td>			
				</tr>
			</table>
		</div>
			<div class="searchDiv">
	...
	<div data-options="region:'center',border:false">
		 <table id="datagrid" data-options="fit:true,pageSize:20,url:'../memberApply?gid=${gid}',method:'get'" class="easyui-datagrid"
			...
			<tr>
				...
				<th  data-options="field:'joinTime'">申请时间</th>
			</tr>
			</thead>
		</table>
	</div>
