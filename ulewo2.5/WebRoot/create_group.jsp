...
<link rel="stylesheet" type="text/css" href="${realPath}/css/group.manage.editgroup.css?version=2.5">
<style type="text/css">
</style>
</head>
<body>
	<%@ include file="common/head.jsp" %>
	<div class="main" style="width:1000px;margin:0px auto">
	...
	<script type="text/javascript" src="${realPath}/js/group.manage.creategroup.js?version=2.5"></script>
</body>
</html>