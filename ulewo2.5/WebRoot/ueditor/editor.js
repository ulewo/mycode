...
UE.commands['preview'] = {
    execCommand : function(){
        var w = window.open('', '_blank', ''),
            d = w.document;
        d.open();
        d.write('<html><head><script src="'+this.options.UEDITOR_HOME_URL+'editor.parse.js"></script><script>' +
...
UE.plugins['catchremoteimage'] = function () {
    ...
    var me = this;
    this.setOpt({
        localDomain:["127.0.0.1","localhost","img.baidu.com","ulewo.com"],
...
(function () {
    ...
    var iframeUrlMap = {
        ...
        'insertimage':'~/dialogs/image/image.html?'+new Date(),
