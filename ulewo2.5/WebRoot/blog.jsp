...
<title>博客-有乐窝</title>
<link rel="stylesheet" type="text/css" href="${realPath}/css/blog.css?version=2.5">
</head>
<body>
	...
	<div class="main">
		...
		<div id="bloglist">
			...
			<div class="blogitem">
				...
				<div class="blog_con">
					<div class="blog_title"><a href="${realPath}/user/${blog.userId}/blog/${blog.blogId}">${blog.title}</a></div>
		...
		<div class="pagination">
			<p:pager url="" page="${result.page.page}" pageTotal = "${result.page.pageTotal }"></p:pager>
		</div>
  </div>
