  	...
  	<div class="main">
		<div class="myinfo">
			<div class="info">
                ...
                <div class="desc">最新版本: </div><div class="text">V2.5.1&nbsp;&nbsp;发布日期: 2014.08.10 &nbsp;&nbsp;软件大小: 865kb</div>
                <div class="desc">版本说明: </div><div class="text">1.签到&nbsp;&nbsp;2.发布吐槽&nbsp;&nbsp;3.发帖&nbsp;&nbsp;4.发博客&nbsp;&nbsp;5.文章浏览、回复</div> 
