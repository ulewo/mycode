...
public class GroupServiceImpl implements GroupService {
	...
	@Override
	public void deleteGroup(Map<String, String> map, SessionUser sessionUser)
			throws BusinessException {
	...
	public UlewoPaginationResult<Group> findAllGroup(Map<String, String> map) {
		...
		List<Group> list = groupMapper.selectExtendInfoList(null, page);
	...
	public Group findGroupBaseInfo(Map<String, String> map)
		...
		Group group = new Group();
		group.setGid(Integer.parseInt(gid));
		Group result = this.groupMapper.selectExtendInfo(group);
		if (null == result) {
