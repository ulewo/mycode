...
public class Constant {
	...
	public final static String ERRORPAGE = "http://www.ulewo.com/error";

	public final static String ISMEMBER = "Y";

	public final static String NOTMEMBER = "N";
