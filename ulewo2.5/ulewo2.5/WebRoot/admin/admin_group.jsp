		...
		<div class="toolbar datagrid-toolbar">
			<table cellpadding="0" cellspacing="0">
				<tr>
					...
					<td><div class="toolbar-line"></div></td>
					<td><a href="javascript:groupManageMember.deleteMember()" class="easyui-linkbutton" data-options="iconCls:'icon-del',plain:true">删除窝窝</a></td>
				</tr>
			</table>
		</div>
			<div class="searchDiv">
		 ...
		 <table id="datagrid" data-options="fit:true,pageSize:20,url:'../member?gid=${gid}',method:'get'" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th  data-options="field:'userIcon',formatter:groupManageMember.userIconFormate">LOGO</th>
					<th  data-options="field:'userName'">窝窝名称</th>
