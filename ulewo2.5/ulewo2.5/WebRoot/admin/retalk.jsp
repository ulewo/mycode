...
<script type="text/javascript" src="../js/admin.retalk.js"></script>
</head>
<body>
<form id="searchForm" action="">
	<table>
		...
		<tr>
			<td><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="retalk.deleteReTalk()" >删除</a></td>
