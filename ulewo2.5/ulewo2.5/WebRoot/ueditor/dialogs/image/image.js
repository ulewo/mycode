...
function showImg(imageUrl){
	var img = document.createElement("img");
    var ci = editor.options.realPath+"/upload/"+imageUrl;
    img.setAttribute("src" ,ci.replace(/\s+|\s+/ig, ""));
...
function changeSelected(o) {
    ...
    if (childs[0].getAttribute("selected")) {
    	childs[0].removeAttribute("selected");
    	childs[1].removeAttribute("class","icondiv");
    } else {
    	childs[0].setAttribute("selected", "true");
    	childs[1].setAttribute("class","icondiv");
    }
}
