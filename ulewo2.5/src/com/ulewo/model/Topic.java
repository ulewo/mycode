...
public class Topic {
	...
	public void setCreateTime(String createTime) {
		...
		this.showCreateTime = StringUtils.friendly_time(this.getCreateTime());
	}
	...
	public boolean isNewPost() {
		...
		try {
			cur = StringUtils.dateFormater.parse(this.createTime);
	...
	public String getDefImage() {
		if (StringUtils.isNotEmpty(topicImage)) {
			this.defImage = this.topicImage.split("\\|")[0];
		}
		return defImage;
	}
