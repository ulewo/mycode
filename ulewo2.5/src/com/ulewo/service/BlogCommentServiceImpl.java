...
public class BlogCommentServiceImpl implements BlogCommentService {
	...
	public BlogComment addBlogComment(Map<String, String> map, SessionUser sessionUser) throws BusinessException {
		...
		if (!StringUtils.isNumber(blogIdStr) || !StringUtils.isNumber(blogUserIdStr)) {
		...
		String formatContent = FormatAt.getInstance().GenerateRefererLinks(userMapper, content, userIds);
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED, rollbackFor = BusinessException.class)
	public void deleteBatch(Map<String, String> param, Integer userId) throws BusinessException {
	...
	@Override
	public UlewoPaginationResult<BlogComment> queryBlogCommentByBlogId(Map<String, String> map)
		...
		List<BlogComment> list = blogCommentMapper.selectBaseInfoList(map, page);
		result.setPage(page);
		result.setList(list);
		return result;
	}
