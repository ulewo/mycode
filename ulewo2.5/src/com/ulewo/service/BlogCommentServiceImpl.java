...
import com.ulewo.vo.BlogCommentVo;
...
public class BlogCommentServiceImpl implements BlogCommentService {
	...
	public void deleteByAdmin(Map<String, String> param)
			throws BusinessException {
	...
	@Override
	public Map<String, Object> queryBlogCommentByBlogId4Api(
			Map<String, String> map) throws BusinessException {
		...
		List<BlogComment> list = blogCommentMapper
				.selectBaseInfoList(map, page);
		List<BlogCommentVo> resultList = new ArrayList<BlogCommentVo>();
		BlogCommentVo vo = null;
		for (BlogComment comment : list) {
			vo = new BlogCommentVo();
			...
			vo.setAtUserId(comment.getAtUserId());
			vo.setAtUserName(comment.getAtUserName());
