...
public class NoticeServiceImpl implements NoticeService {
    ...
    @Override
    public UlewoPaginationResult<Notice> queryNoticeByUserId(
	    Map<String, String> map, Integer userId) {
	int page_no = 0;
	...
	UlewoPaginationResult<Notice> result = new UlewoPaginationResult<Notice>(
		page, list);
	return result;
    }
