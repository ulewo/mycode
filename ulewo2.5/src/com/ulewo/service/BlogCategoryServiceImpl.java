...
public class BlogCategoryServiceImpl implements BlogCategoryService {
	...
	@Override
	public BlogCategory findCategoryById(Map<String, String> map, SessionUser sessionUser) throws BusinessException {
	...
	@Override
	public void saveCategory(Map<String, String> map, Integer userId) throws BusinessException {
		try {
			...
			List<BlogCategory> insertList = JSONArray.toList(insertArray, new BlogCategory(), new JsonConfig());
			List<BlogCategory> updateList = JSONArray.toList(updateArray, new BlogCategory(), new JsonConfig());
			List<BlogCategory> deleteList = JSONArray.toList(deleteArray, new BlogCategory(), new JsonConfig());
	...
	private void addCategory(List<BlogCategory> insertList, Integer userId) throws BusinessException {
	...
	private void updateCategory(List<BlogCategory> updateList, Integer userId) throws BusinessException {
	...
	private void deleteCategory(List<BlogCategory> deleteList, Integer userId) throws BusinessException {
		for (BlogCategory category : deleteList) {
			Map<String, String> param = new HashMap<String, String>();
			param.put("categoryId", String.valueOf(category.getCategoryId()));
			param.put("userId", String.valueOf(userId));
			BlogCategory categorytemp = blogCategoryMapper.selectBaseInfo(param);
