...
public class GroupMemberServiceImp extends GroupAuthorityService implements GroupMemberService {
	...
	@Override
	public GroupMember joinGroup(Map<String, String> map, Integer userId) throws BusinessException {
		...
		member.setJoinTime(StringUtils.dateFormater.get().format(new Date()));
	...
	@Override
	public void existGroup(Map<String, String> map, Integer userId) throws BusinessException {
		String gid = map.get("gid");
		if (StringUtils.isEmpty("gid") || !StringUtils.isNumber(gid)) {
			throw new BusinessException("参数错误!");
		}
	...
	public void deleteMember(Map<String, String> map, Integer userId) throws BusinessException {
		String gid = map.get("gid");
		if (StringUtils.isEmpty(gid) || !StringUtils.isNumber(gid)) {
			throw new BusinessException("参数错误!");
		}
	...
	@Override
	public void accetpMember(Map<String, String> map, Integer userId) throws BusinessException {
		String gid = map.get("gid");
		if (StringUtils.isEmpty(gid) || !StringUtils.isNumber(gid)) {
			throw new BusinessException("参数错误!");
		}
	...
	@Override
	public UlewoPaginationResult<GroupMember> findMembers(Map<String, String> map) {
		int page_no = 0;
		...
		List<GroupMember> list = this.groupMemberMapper.selectBaseInfoList(map, page);
	...
	@Override
	public UlewoPaginationResult4Json<GroupMember> findMembers4Json(Map<String, String> map) {
		int page_no = 0;
		if (StringUtils.isNumber(map.get("page"))) {
			page_no = Integer.parseInt(map.get("page"));
		}
