		...
		<div class="right" id="right">
			<div class="blog_list">
				...
				<div class="blog_detail">
						...
						<div class="blog_item_op" style="height:20px;">
							<div class="blog_item_op_info"><span>发布于 ${blog.showCreateTime}，阅读(<span class="blog_item_op_red">${blog.readCount}</span>)|评论(<span class="blog_item_op_red">${blog.commentCount}</span>)</span></div>
						</div>
				...
				<div class="blog_item_op" style="height:20px;border:1px solid #EEEEEE;padding:8px;">
						<div style="float:left;width:120px;">
								<div class="op_like_tit">你的态度：</div><a href="javascript:void(0)" opid="${blog.blogId}" type="B" disable = "false" class="op_like" title="赞"><span>${blog.likeCount}</span></a>
						</div>
						<div class="share">
						...
						<div class="blog_item_op_favorite">
							<span id="favoriteCount">0</span>人收藏了此文章 <span id="op_favorite"></span>
							<c:if test="${user!=null}">
								<a href="${realPath}/manage/main#collectionB" target="_blank">查看我的收藏</a>
							</c:if>
						</div>
				</div>
				<div class="blog_reply">
					...
					<div id="loading" ><img src="${realPath}/images/load.gif" >评论加载中......</div>
				</div>
					...
					<form id="subform"> 
				  		...
				  		<div>
				  			<div class="blogreply_icon">
				  				<c:if test="${user!=null}">
									<img src="${realPath}/upload/${user.userIcon}" width="37">
								</c:if>
								<c:if test="${user==null}">
