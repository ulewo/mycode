...
adminTopicComment.gid = "${gid}";
</script>
<script type="text/javascript" src="${realPath}/js/admin.topic_comment.js?version=2.5"></script>
</head>
<body class="easyui-layout">
	<div data-options="region:'north',border:false">
		<div class="toolbar datagrid-toolbar">
			<table cellpadding="0" cellspacing="0">
				<tr>
					<td><a href="javascript:adminTopicComment.search()" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">查询</a></td>
		 ...
		 <table id="datagrid_comment" data-options="fit:true,pageSize:20,toolbar:'#comment_toolbar'" class="easyui-datagrid"
			...
			<thead>
				<tr>
					...
					<th field="simpleContent" width="400" >评论</th>
					<th field="userName" align="left">发布人</th>
					<th field="showCreateTime" align="center">发布时间</th>
				</tr>
			</thead>
	...
	<div id="comment_toolbar" class="toolbar datagrid-toolbar">
		<a href="javascript:adminTopicComment.deleteComment()" class="easyui-linkbutton" data-options="iconCls:'icon-del',plain:true">删除评论</a>
	</div>
</body>
</html>